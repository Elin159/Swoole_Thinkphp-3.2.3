 ...
 * @filename : Yprint.class.php
 * @author   : heqian@yilianyun.net
 * @date     : 2016-07-11
 */
namespace Org\Yprint;
class Yprint{

    private $apiKey = '';
    private $msign = '';

    private function __construct($msign)
    {
        $this->apiKey = "fa8aff6b11be6e50809d46bda777e845ab2fcf7c";
...
public function  action_print($partner,$machine_code,$content)
{
...
//        . implode(', ', $arguments). "\n";
//}
public static function Yprint($msign) {
    return new static($msign);
}
