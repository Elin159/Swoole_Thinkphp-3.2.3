...
//    const SYNC_COMPANY_USER_INFO_PATH = "wbap-bbfront/ngos";
    const SYNC_COMPANY_USER_INFO_PATH = "api/oauth2/access_token";
     ...
     */
    public static function execute($app_id, $secret, $grant_type, $version)
    {
//        $header = ['Content-Type: application/json; charset=utf-8'];
//        $header = ['Content-Type: text/xml'];
        $request = array(
            'url' => Config::getBaseUrl() . self::SYNC_COMPANY_USER_INFO_PATH . '?app_id='. $app_id.'&secret='.$secret.'&grant_type='.$grant_type.'&version='.$version,
            'method' => 'get',
