...
//    const SYNC_COMPANY_USER_INFO_PATH = "wbap-bbfront/ngos";
    const SYNC_COMPANY_USER_INFO_PATH = "api/oauth2/api_ticket";
    //HTTP请求超时时间
     ...
     */
    public static function execute($app_id, $access_token, $type = 'SIGN', $version = '1.0.0')
    {
//        $header = ['Content-Type: application/json; charset=utf-8'];
//        $header = ['Content-Type: text/xml'];
        $request = array(
            'url' => Config::getBaseUrl() . self::SYNC_COMPANY_USER_INFO_PATH . '?app_id='. $app_id.'&access_token='.$access_token.'&type='.$type.'&version='.$version,
            'method' => 'get',
