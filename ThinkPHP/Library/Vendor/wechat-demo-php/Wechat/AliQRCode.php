...
//    const SYNC_COMPANY_USER_INFO_PATH = "wbap-bbfront/ngos";
    const SYNC_COMPANY_USER_INFO_PATH = "api/aap/server/wepay/scancodepay";
//https://l.test-svrapi.webank.com/api/aap/server/wepay/scancodepay
     ...
     */
    public static function execute($jsonData, $nonce, $sign, $version)
    {
